...
// SHASHLIK NOTE: This file and ShashlikRuntime.cpp are copies of
...
#ifndef _RUNTIME_SHASHLIK_RUNTIME_H
#define _RUNTIME_SHASHLIK_RUNTIME_H
...
public:
    ...
    static ShashlikRuntime* getRuntime();
