...
// SHASHLIK NOTE: This file and ShashlikRuntime.h are copies of
//                AndroidRuntime.h and .cpp from frameworks-base. We are
//                copying it to avoid having to also build the Skia library
//                and avoid having to dragin in the frameworks-native
//                repository.
...
static ShashlikRuntime* gCurRuntime = NULL;
...
/*static*/ JavaVM* ShashlikRuntime::mJavaVM = NULL;


ShashlikRuntime::ShashlikRuntime() :
        mExitWithoutCleanup(false)
{
#if 0 // IW: Temporarily disabling.  Will be rewritten to use Qt instead.
 ...
 */
/*static*/ int ShashlikRuntime::registerNativeMethods(JNIEnv* env,
    const char* className, const JNINativeMethod* gMethods, int numMethods)
{
    return jniRegisterNativeMethods(env, className, gMethods, numMethods);
}

status_t ShashlikRuntime::callMain(const char* className,
 ...
 */
int ShashlikRuntime::addVmArguments(int argc, const char* const argv[])
{
    int i;
 ...
 */
void ShashlikRuntime::parseExtraOpts(char* extraOptsBuf)
{
    JavaVMOption opt;
    char* start;
    char* end;
 ...
 */
int ShashlikRuntime::startVm(JavaVM** pJavaVM, JNIEnv** pEnv)
{
    int result = -1;
...
char* ShashlikRuntime::toSlashClassName(const char* className)
{
 ...
 * options string.
 */
void ShashlikRuntime::start(const char* className, const char* options)
{
    ALOGD("\n>>>>>> ShashlikRuntime START %s <<<<<<\n",
...
void ShashlikRuntime::exit(int code)
{
...
void ShashlikRuntime::onVmCreated(JNIEnv* env)
{
    // If ShashlikRuntime had anything to do here, we'd have done it in 'start'.
}
 ...
 */
/*static*/ JNIEnv* ShashlikRuntime::getJNIEnv()
{
    JNIEnv* env;
    JavaVM* vm = ShashlikRuntime::getJavaVM();
    assert(vm != NULL);
 ...
 */
/*static*/ int ShashlikRuntime::javaThreadShell(void* args) {
 ...
 */
/*static*/ int ShashlikRuntime::javaCreateThreadEtc(
                                ...
                                android_thread_id_t* threadId)
{
    ...
    result = androidCreateRawThreadEtc(ShashlikRuntime::javaThreadShell, args,
 ...
 */
/*static*/ android_thread_id_t ShashlikRuntime::createJavaThread(const char* name,
 ...
 */
/*static*/ int ShashlikRuntime::startReg(JNIEnv* env)
{
    /*
...
ShashlikRuntime* ShashlikRuntime::getRuntime()
{
    return gCurRuntime;
}
